...
\mbox{important} for those agents to be able to communicate the minimum amount of
...
need to understand properties of during training to optimize training parameters.
...
\node at (5,1.2) {\small ``The first bit of $x$ is a $1$.''};
\draw (1,0.5) -- (2,1);
\draw (1,0.5) -- (2,1.5);
...
\node at (6.5,-1.3) {\small ``The second bit of $y$ is a $0$.''};
\draw (9.5,-1) -- (11,-0.5); 
\draw (9.5,-1.5) -- (11,-0.5);  


\end{tikzpicture}
\caption{Alice and Bob communicating parts of their input.}
\end{figure}
