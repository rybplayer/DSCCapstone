...
\end{align}
\end{definition}
The above definition generalizes to $\TRAV_k$, the traversal problem with $k$ players, as seen in Definition \ref{def:multi-party-trav}. The following figures illustrate what $\TRAV_2$ may look like.
