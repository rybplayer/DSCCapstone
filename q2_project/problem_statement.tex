...
\begin{proof}
	...
	non-equidistant points exist, both players can use their shared
	randomness to pick a point of intersection, and follow one of the paths
...
\susubsection{Lower bound without shared randomness}

\begin{claim}
	Both players can reach their endpoints with % Some amount
	of communication complexity, without using public randomness
\end{claim}
