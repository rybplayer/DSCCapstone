...
listed assumptions, and find a $\Omega(1)$ lower bound for this problem

\subsection{Lower bound with all Assumptions}

We start with the following claim: Both players can reach their endpoints without collisions using
...
If there are shortest paths with no intersection point, than it
...
guaranteeing that they will not intersect at the same time. 

If non-equidistant points exist, both players can use a shared
